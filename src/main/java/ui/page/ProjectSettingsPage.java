...
public class ProjectSettingsPage extends BasePage {
    ...
    private String projectSettingsUpdatedSuccessfulyText = "Project settings were successfully updated!";
    ...
    public String getPageTitle() {
        return waitVisibilityOfElement(pageTitle).getText();
    }
    ...
    public void clickOnUpdateSettingsButton() {
        ...
        waitVisibilityOfElement(updateSettingsButton).click();
        AllureUtils.takeScreenshot(driver);
    }
    ...
    public boolean isAlertOnSuccessfulProjectUpdateAppears() {
        ...
        By alertElement = getElementLocatorByPathAndOneParam(alertPopupPath, projectSettingsUpdatedSuccessfulyText);
