...
public class CreateNewProjectDialog extends BasePage {
    ...
    private static final String PROJECT_ACCESS_TYPE_RADIO_BUTTON_PATH = "//input[@type='radio' and @value='%s']/ancestor::label";
    ...
    public CreateNewProjectDialog chooseProjectAccessType(String accessType) {
        if (accessType != null) {
            ...
            By accessTypeRadioButton = getElementLocatorByPathAndOneParam(PROJECT_ACCESS_TYPE_RADIO_BUTTON_PATH, accessType.toLowerCase());
